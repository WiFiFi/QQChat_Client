...
public class ClientThread implements Runnable {
    ...
    private static final String SOCKET_IP = "192.168.43.95";
    private static final int SOCKET_PORT = 52000;
    // 以下是HTTP接口调用的服务地址，根据实际情况修改IP和端口
    public static final String REQUEST_URL = "http://192.168.43.95:8080/NetServer";
    ...
    public static String ACTION_REGISTER = "com.example.network.REGISTER";
    public static String ACTION_LOGIN = "com.example.network.LOGIN";
    ...
    public static String REGISTER = "REGISTER"; // 注册
    ...
    private class RecvThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                e.printStackTrace();
                ClientThread.this.notify(99, e.getMessage());
            }
        }
    }
    ...
    private void notify(int type, String message) {
        if (type == 99) { // 连接异常
            ...
            } else if (splitArray[0].equals(REGISTER)) {//获得注册结果
                action = ACTION_REGISTER;
            } else if (splitArray[0].equals(LOGIN)) {//获得登录结果
                action = ACTION_LOGIN;
            }
